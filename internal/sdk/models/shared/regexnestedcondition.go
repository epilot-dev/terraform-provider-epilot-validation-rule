...
type RegexNestedCondition struct {
	One   *One   `queryParam:"inline,name=RegexNestedCondition" union:"member"`
	Two   *Two   `queryParam:"inline,name=RegexNestedCondition" union:"member"`
	Three *Three `queryParam:"inline,name=RegexNestedCondition" union:"member"`
