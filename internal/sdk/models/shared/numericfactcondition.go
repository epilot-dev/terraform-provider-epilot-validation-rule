...
type NumericFactCondition struct {
	NumericFactCondition1 *NumericFactCondition1 `queryParam:"inline,name=NumericFactCondition" union:"member"`
	NumericFactCondition2 *NumericFactCondition2 `queryParam:"inline,name=NumericFactCondition" union:"member"`
	NumericFactCondition3 *NumericFactCondition3 `queryParam:"inline,name=NumericFactCondition" union:"member"`
	NumericFactCondition4 *NumericFactCondition4 `queryParam:"inline,name=NumericFactCondition" union:"member"`
