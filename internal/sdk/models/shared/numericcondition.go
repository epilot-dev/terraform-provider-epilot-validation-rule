...
type NumericConditionNot struct {
	NumericFactCondition   *NumericFactCondition   `queryParam:"inline,name=not" union:"member"`
	NumericNestedCondition *NumericNestedCondition `queryParam:"inline,name=not" union:"member"`
...
type NumericConditionAny struct {
	NumericFactCondition   *NumericFactCondition   `queryParam:"inline,name=any" union:"member"`
	NumericNestedCondition *NumericNestedCondition `queryParam:"inline,name=any" union:"member"`
...
type NumericConditionAll struct {
	NumericFactCondition   *NumericFactCondition   `queryParam:"inline,name=all" union:"member"`
	NumericNestedCondition *NumericNestedCondition `queryParam:"inline,name=all" union:"member"`
...
type NumericCondition struct {
	NumericCondition1 *NumericCondition1 `queryParam:"inline,name=NumericCondition" union:"member"`
	NumericCondition2 *NumericCondition2 `queryParam:"inline,name=NumericCondition" union:"member"`
	NumericCondition3 *NumericCondition3 `queryParam:"inline,name=NumericCondition" union:"member"`
