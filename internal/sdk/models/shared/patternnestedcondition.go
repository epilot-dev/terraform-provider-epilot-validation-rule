...
type PatternNestedCondition struct {
	PatternNestedCondition1 *PatternNestedCondition1 `queryParam:"inline,name=PatternNestedCondition" union:"member"`
	PatternNestedCondition2 *PatternNestedCondition2 `queryParam:"inline,name=PatternNestedCondition" union:"member"`
	PatternNestedCondition3 *PatternNestedCondition3 `queryParam:"inline,name=PatternNestedCondition" union:"member"`
