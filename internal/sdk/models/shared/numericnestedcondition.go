...
type NumericNestedCondition struct {
	NumericNestedCondition1 *NumericNestedCondition1 `queryParam:"inline,name=NumericNestedCondition" union:"member"`
	NumericNestedCondition2 *NumericNestedCondition2 `queryParam:"inline,name=NumericNestedCondition" union:"member"`
	NumericNestedCondition3 *NumericNestedCondition3 `queryParam:"inline,name=NumericNestedCondition" union:"member"`
