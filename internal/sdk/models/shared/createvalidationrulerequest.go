...
type CreateValidationRuleRequestRule struct {
	RegexRuleType   *RegexRuleType   `queryParam:"inline,name=rule" union:"member"`
	PatternRuleType *PatternRuleType `queryParam:"inline,name=rule" union:"member"`
	NumericRuleType *NumericRuleType `queryParam:"inline,name=rule" union:"member"`
