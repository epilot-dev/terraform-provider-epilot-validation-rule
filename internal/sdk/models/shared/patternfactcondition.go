...
type PatternFactCondition struct {
	PatternFactCondition1 *PatternFactCondition1 `queryParam:"inline,name=PatternFactCondition" union:"member"`
	PatternFactCondition2 *PatternFactCondition2 `queryParam:"inline,name=PatternFactCondition" union:"member"`
	PatternFactCondition3 *PatternFactCondition3 `queryParam:"inline,name=PatternFactCondition" union:"member"`
	Four                  *Four                  `queryParam:"inline,name=PatternFactCondition" union:"member"`
